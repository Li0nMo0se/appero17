...
class IsEulerianTestCase(unittest.TestCase):
    ...
    def test_oriented_true(self):
        ...
        self.assertEqual(True, snowymontreal.is_eulerian(num_vertices,
                                                         edges_list, is_oriented))
    ...
    def test_oriented_false(self):
        ...
        edges_list = [(0, 1, 1), (1, 2, 2), (2, 3, 3), (3, 4, 4), (4, 0, 5),
                      (0, 5, 1)]
        self.assertEqual(False, snowymontreal.is_eulerian(num_vertices,
                                                          edges_list, is_oriented))
...
class IsEulerianCycleTestCase(unittest.TestCase):
    def test_eulerian_cycle_true(self):
        ...
        self.assertEqual(solve_help.is_eulerian_cycle(4, edges, False,
                                                      cycle), True)
    ...
    def test_eulerian_cycle_one_edge(self):
        edges = [(1, 1, 0)]
        cycle = [1]
        self.assertEqual(solve_help.is_eulerian_cycle(2, edges, False,
                                                      cycle), True)
    ...
    def test_eulerian_cycle_directed(self):
        ...
        edges_list = [(0, 1, 1), (1, 2, 2), (2, 3, 3), (3, 4, 4), (4, 0, 5)]
        cycle = [0, 1, 2, 3, 4]
        self.assertEqual(True, solve_help.is_eulerian_cycle(num_vertices,
                                                            edges_list, is_oriented, cycle))
    ...
    def test_eulerian_not_cycle_directed(self):
        ...
        edges_list = [(0, 1, 1), (1, 2, 2), (2, 3, 3), (3, 4, 4), (4, 0, 5)]
        cycle = [1, 2, 3, 0, 4]
        self.assertEqual(False, solve_help.is_eulerian_cycle(num_vertices,
                                                             edges_list, is_oriented, cycle))
...
class FindEulerianCycleTestCase(unittest.TestCase):
    ...
    def test_find_eulerian_cycle_directed(self):
        ...
        num_vertices = 5
        edges_list = [(0, 1, 1), (1, 2, 2), (2, 3, 3), (3, 4, 4), (4, 0, 5)]
        self.assertEqual(True, snowymontreal.is_eulerian_cycle(num_vertices,
                                                               edges_list, is_oriented,
                                                               snowymontreal.find_eulerian_cycle(
                                                                   num_vertices, edges_list, is_oriented)))


class OddVerticeTestCase(unittest.TestCase):
    def test_odd_vertices_undirected(self):
        self.assertEqual(solve_help.odd_vertices_undirected(4,
                                                            [(0, 3, 0), (3, 2, 0), (1, 2, 0), (3, 1, 0)]), [0, 3])

    def test_odd_vertices_undirected_2(self):
        self.assertEqual(True, solve_help.test_vertices_eulerian(3, [(1, 1,
                                                                      0)]))
    ...
    def test_odd_vertices_directed_already_eulerian(self):
        ...
        num_vertices = 5
        edges_list = [(0, 1, 1), (1, 2, 2), (2, 3, 3), (3, 4, 4), (4, 0, 5)]
        self.assertEqual(True, solve_help.test_vertices_eulerian(
...
class IsConnectedTestCase(unittest.TestCase):
    ...
    def test_is_directed_eulerian_connected(self):
        ...
        num_vertices = 5
        edges_list = [(0, 1, 1), (1, 2, 2), (2, 3, 3), (3, 4, 4), (4, 0, 5)]
        self.assertEqual(solve_help.is_connected(num_vertices, edges_list,
...
class EulerizeTestCase(unittest.TestCase):
    def test_eulerize_undirected(self):
        edges_list = [(0, 2, 0), (0, 4, 3), (0, 5, 0), (1, 4, 2), (1, 5, 1),
                      (2, 3, 4), (2, 4, 3), (4, 5, 1)]
        num_vertices = 6
        snowymontreal.eulerize(num_vertices, edges_list, is_oriented=False)
        self.assertEqual(True, snowymontreal.is_eulerian(num_vertices,
                                                         edges_list,
                                                         is_oriented=False))
    ...
    def test_eulerize_directed(self):
        ...
        num_vertices = 6
        snowymontreal.eulerize(num_vertices, edges_list, is_oriented=True)
        self.assertEqual(True, snowymontreal.is_eulerian(num_vertices,
                                                         edges_list,
                                                         is_oriented=True))
...
class SolveTestcase(unittest.TestCase):
    ...
    def test_solve_undirected_1(self):
        is_oriented = False
        num_vertices = 6
        edges_list = [(0, 1, 1), (0, 3, 1), (0, 4, 4), (1, 2, 2), (1, 4, 3), (2, 5, 1), (3, 4, 2), (4, 5, 1),
                      (5, 2, 56)]
        cycle = snowymontreal.solve(is_oriented, num_vertices, edges_list)
    ...
    def test_solve_undirected_5(self):
        is_oriented = False
        num_vertices = 9
        edges_list = [(1, 2, 3), (1, 7, 8), (2, 3, 6), (2, 4, 4), (3, 4, 1), (3, 5, 2), (3, 7, 1), (4, 8, 4), (5, 6, 3),
                      (5, 0, 1), (6, 0, 2), (6, 7, 6)]
        cycle = snowymontreal.solve(is_oriented, num_vertices, edges_list)
        self.assertEqual(solve_help.is_eulerian_cycle(num_vertices, edges_list, is_oriented, cycle), True)
